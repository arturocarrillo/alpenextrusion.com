...
function cambiarIdiomaEspañol() {
  ...
  // Cambiar texto 
  document.getElementById('t-serv-1').innerText = 'Nuestros servicios';
  ...
  document.getElementById('btn-serv-1').innerText = 'Más información';
  document.getElementById('btn-serv-2').innerText = 'Más información';
  document.getElementById('btn-serv-3').innerText = 'Más información';
...
function cambiarIdiomaIngles() {
  ...
  document.getElementById('btn-serv-1').innerText = 'More information here';
  document.getElementById('btn-serv-2').innerText = 'More information here';
  document.getElementById('btn-serv-3').innerText = 'More information here';
