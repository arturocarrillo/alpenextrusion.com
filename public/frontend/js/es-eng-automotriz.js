...
function cambiarIdiomaEspañol() {
  ...
  // Cambiar texto 
  document.getElementById('t-serv-1').innerText = 'Automotriz';
  document.getElementById('t-serv-2').innerText = 'Construcción de carrocería y chasis, fabricamos paneles exteriores (puertas, capos y techos).';
...
function cambiarIdiomaIngles() {
  ...
  // Cambiar texto 
  document.getElementById('t-serv-1').innerText = 'Automotive';
  document.getElementById('t-serv-2').innerText = 'Construction of body and chassis, manufacturing of exterior panels (doors, hoods and roofs).';
