...
function cambiarIdiomaEspañol() {
  ...
  // Cambiar texto 
  document.getElementById('t-serv-1').innerText = 'Arquitectónico';
  document.getElementById('t-serv-2').innerText = 'Realizamos piezas que se utilizan para construir estructuras y elementos diversos. Fabricamos perfiles para marcos de ventanas, puertas, estructura de paneles solares y edificios.';
...
function cambiarIdiomaIngles() {
  ...
  // Cambiar texto 
  document.getElementById('t-serv-1').innerText = 'Architectonic';
  document.getElementById('t-serv-2').innerText = 'We produce parts that are used to build structures and various elements. We manufacture profiles for window frames, doors, solar panel structures and buildings.';
